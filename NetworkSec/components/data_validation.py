...
import pandas as pd
import os, sys
from NetworkSec.utils.main_utils.utils import read_yaml_file, write_yaml_file
...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            # FIX: get number of expected columns from schema
    ...
    def detect_dataset_drift(self, base_df, current_df, threshold=0.05) -> bool:
        try:
            ...
            # FIX: return status so initiate_data_validation can use it
            return status
